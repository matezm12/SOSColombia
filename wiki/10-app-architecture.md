...
10. Not started: public deploy itself (the code no longer blocks it, but nobody's pulled the trigger — Vercel project creation is a "creating an account/service" action, same category as the Supabase signup earlier).
