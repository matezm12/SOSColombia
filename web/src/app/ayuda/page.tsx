...
export default async function AyudaPage(props: PageProps<"/ayuda">) {
  ...
  return (
    <PageShell
      ...
      lede="Todos los puntos de ayuda verificados, de todas las ciudades. Filtra por tipo o entra a la página de cada ciudad para ver solo la suya."
    >
      ...
      <div className="mt-6 space-y-8">
        ...
        {points.length === 0 && <EmptyState>Sin puntos de ayuda para este filtro.</EmptyState>}
      </div>
    </PageShell>
  );
}
