...
async function main() {
  ...
  const campaignDefs: Array<Record<string, unknown> & { municipios?: string[] }> = [
    ...
    { platform: 'OTHER', title: 'Ayuda alimentaria — "Goticas"', orgOrPerson: 'Fundación Éxito', url: 'https://www.fundacionexito.org', goal: null, raised: null, donorCount: null, currency: 'COP', verificationStatus: 'VERIFIED', notes: 'Also runs an in-store donation-box channel ("Goticas") at Éxito stores, not just online.', lastCheckedAt: new Date('2026-08-14'), municipios: ['27660', '76001', '66001', '17001'] },
