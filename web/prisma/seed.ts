...
async function main() {
  ...
  await prisma.crowdfundingCampaign.createMany({
    data: [
      { platform: 'GOFUNDME', title: 'Relief Supplies for Colombia Earthquake', orgOrPerson: 'Camila Franco', url: 'https://www.gofundme.com/f/relief-supplies-for-colombia-earthquake', goal: 1600, raised: 1262, donorCount: 19, verificationStatus: 'PLAUSIBLE', lastCheckedAt: new Date('2026-08-13') },
      { platform: 'GOFUNDME', title: 'Rescate x Colombia', orgOrPerson: 'Laura U', url: 'https://www.gofundme.com/f/rescate-x-colombia-movilizamos-ayuda-a-la-zona-del-sismo', goal: 28000, raised: 20591, donorCount: 206, verificationStatus: 'PLAUSIBLE', lastCheckedAt: new Date('2026-08-13') },
      ...
      { platform: 'GOFUNDME', title: 'Colombia Earthquake: Help Families Rebuild', orgOrPerson: 'Dahiana Parra', url: 'https://www.gofundme.com/f/colombia-earthquake-help-families-rebuild', goal: 22000, raised: 2000, donorCount: 15, currency: 'CHF', verificationStatus: 'PLAUSIBLE', lastCheckedAt: new Date('2026-08-13') },
      { platform: 'GOFUNDME', title: 'Colombia Needs Your Help After the Earthquake', orgOrPerson: 'Vanessa Martinez', url: 'https://www.gofundme.com/f/colombia-needs-your-help-after-the-earthquake', goal: 2400, raised: 575, donorCount: 16, currency: 'GBP', verificationStatus: 'PLAUSIBLE', lastCheckedAt: new Date('2026-08-13') },
    ],
  })
