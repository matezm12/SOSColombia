...
async function main() {
  ...
  await prisma.tollRecord.createMany({
    data: [
      ...
      { metric: 'MISSING_OFFICIAL', value: 287, sourceId: sources.ungrd_balance_0812, tier: 2, asOf: new Date('2026-08-12T07:30:00-05:00'), notes: 'Institutional count — distinct from the crowdsourced MISSING_CROWDSOURCED figure below, never merge the two' },
  ...
  // City focus is a many-to-many (never a single FK — real campaigns are
  // genuinely multi-city, e.g. CARE names 4). Only tagged when a campaign's
  // own wiki entry names a specific municipio we have; department-only
  // mentions ("Chocó") are deliberately left untagged rather than guessed
  // onto one of its cities — see wiki/11-crowdfunding-campaigns.md.
  const campaignDefs: Array<Record<string, unknown> & { municipios?: string[] }> = [
    { platform: 'GOFUNDME', title: 'Relief Supplies for Colombia Earthquake', orgOrPerson: 'Camila Franco', url: 'https://www.gofundme.com/f/relief-supplies-for-colombia-earthquake', goal: 1600, raised: 1262, donorCount: 19, verificationStatus: 'PLAUSIBLE', international: true, lastCheckedAt: new Date('2026-08-13'), municipios: ['66001'] },
    { platform: 'GOFUNDME', title: 'Rescate x Colombia', orgOrPerson: 'Laura U', url: 'https://www.gofundme.com/f/rescate-x-colombia-movilizamos-ayuda-a-la-zona-del-sismo', goal: 28000, raised: 20591, donorCount: 206, verificationStatus: 'PLAUSIBLE', international: true, lastCheckedAt: new Date('2026-08-13'), municipios: ['66001', '17001', '63001'] },
    { platform: 'VAKI', title: 'Yo Tengo Fe por el Pacífico', orgOrPerson: 'Willy García', url: 'https://vaki.co/vaki/yo-tengo-fe-por-el-pacifico', goal: null, raised: 0, donorCount: 0, verificationStatus: 'VERIFIED', international: true, lastCheckedAt: new Date('2026-08-14') },
    { platform: 'OTHER', title: 'Emergencia Colombia Sismo', orgOrPerson: 'UNICEF Colombia', url: 'https://unicef.org.co/terremoto-colombia', goal: null, raised: null, donorCount: null, verificationStatus: 'VERIFIED', international: true, lastCheckedAt: new Date('2026-08-14') },
    { platform: 'OTHER', title: 'Emergencia Colombia Terremoto', orgOrPerson: 'Cruz Roja Colombiana', url: 'https://ayuda.cruzrojacolombiana.org/emergencia-colombia-terremoto', goal: null, raised: null, donorCount: null, verificationStatus: 'VERIFIED', international: true, lastCheckedAt: new Date('2026-08-14'), municipios: ['27660', '17001', '63001'] },
    { platform: 'OTHER', title: 'Colombia en emergencia', orgOrPerson: 'The House Project (Familia Montaner)', url: 'https://thehouse-project.org/products/colombia-needs-us', goal: null, raised: null, donorCount: null, verificationStatus: 'VERIFIED', international: true, lastCheckedAt: new Date('2026-08-14') },
    { platform: 'OTHER', title: 'Emergency Appeal: Earthquake Victims in Colombia', orgOrPerson: 'Children Change Colombia', url: 'https://childrenchangecolombia.org/emergency-appeal-urgent-assistance-for-earthquake-victims-in-colombia/', goal: null, raised: null, donorCount: null, verificationStatus: 'VERIFIED', international: true, lastCheckedAt: new Date('2026-08-14') },
    { platform: 'GOFUNDME', title: 'Ayudas para las comunidades indígenas del Chocó', orgOrPerson: 'Galería Aborigen (organizer: Camila Barrera, Austin TX)', url: 'https://www.gofundme.com/f/ayudas-para-las-comunidades-indigenas-del-choco', goal: 230000, raised: 170903, donorCount: 3962, currency: 'USD', verificationStatus: 'PLAUSIBLE', international: true, notes: 'GoFundMe organizer is a US-based individual, not obviously the same legal entity as the Bogotá-based foundation — no NIT found, PayPal option is a personal Gmail address. Not flagged as fraud (real address/history, no fraud reports) but a genuine trust gap vs. the tier-1 orgs above.', lastCheckedAt: new Date('2026-08-14'), municipios: ['27660'] },
    // Pass 4 additions (2026-08-14)
    { platform: 'OTHER', title: 'Disaster Relief Fund', orgOrPerson: 'World Vision', url: 'https://donate.worldvision.org/give/disaster-relief', goal: null, raised: null, donorCount: null, currency: 'USD', verificationStatus: 'VERIFIED', international: true, lastCheckedAt: new Date('2026-08-14') },
    { platform: 'OTHER', title: 'Colombia Earthquake Response', orgOrPerson: 'CARE', url: 'https://www.care.org/media-and-press/colombia-earthquake-communities-cope-with-loss-damage-and-uncertainty', goal: null, raised: null, donorCount: null, currency: 'USD', verificationStatus: 'VERIFIED', international: true, lastCheckedAt: new Date('2026-08-14'), municipios: ['66001', '27001', '76001', '17001'] },
    { platform: 'OTHER', title: 'Colombia Earthquake Emergency Fund', orgOrPerson: 'Save the Children', url: 'https://www.savethechildren.net/what-we-do/emergencies/colombia-earthquake', goal: null, raised: null, donorCount: null, currency: 'USD', verificationStatus: 'VERIFIED', international: true, lastCheckedAt: new Date('2026-08-14') },
    { platform: 'OTHER', title: 'Ayuda alimentaria — "Goticas"', orgOrPerson: 'Fundación Éxito', url: 'https://www.fundacionexito.org', goal: null, raised: null, donorCount: null, currency: 'COP', verificationStatus: 'VERIFIED', notes: 'También opera un canal de donación en tienda (cajas "Goticas") en los almacenes Éxito, no solo en línea.', lastCheckedAt: new Date('2026-08-14'), municipios: ['27660', '76001', '66001', '17001'] },
    { platform: 'OTHER', title: 'Canal de apoyo — cuenta de ahorros 24542391932', orgOrPerson: 'Fundación Bancolombia', url: 'https://www.linkedin.com/posts/fundacion-bancolombia_desde-la-fundaci%C3%B3n-bancolombia-nos-activamos-activity-7480016574050082816-NLsY', goal: null, raised: null, donorCount: null, currency: 'COP', verificationStatus: 'VERIFIED', notes: 'Confirmed via their own official LinkedIn post. Same post names a second account for Cáritas Colombiana (82900024657) and a Wompi link, not separately seeded. COP bank transfer only — not reachable from abroad, so excluded from the international list.', lastCheckedAt: new Date('2026-08-14') },
    ...
    { platform: 'GOFUNDME', title: 'Colombia Earthquake: Help Families Rebuild', orgOrPerson: 'Dahiana Parra', url: 'https://www.gofundme.com/f/colombia-earthquake-help-families-rebuild', goal: 22000, raised: 2000, donorCount: 15, currency: 'CHF', verificationStatus: 'PLAUSIBLE', international: true, lastCheckedAt: new Date('2026-08-13') },
    { platform: 'GOFUNDME', title: 'Colombia Needs Your Help After the Earthquake', orgOrPerson: 'Vanessa Martinez', url: 'https://www.gofundme.com/f/colombia-needs-your-help-after-the-earthquake', goal: 2400, raised: 575, donorCount: 16, currency: 'GBP', verificationStatus: 'PLAUSIBLE', international: true, lastCheckedAt: new Date('2026-08-13') },
  ]
  for (const { municipios, ...campaign } of campaignDefs) {
    await prisma.crowdfundingCampaign.create({
      data: {
        ...campaign,
        ...(municipios ? { municipios: { connect: municipios.map((divipolaCode) => ({ divipolaCode })) } } : {}),
      } as never,
    })
  }
